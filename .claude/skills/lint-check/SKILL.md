...
- There are no JS/CSS lint layers: `resources/js/app.js` only boots Alpine.js and
  `resources/css/app.css` is the Tailwind 4 entry — nothing to lint there.
- Don't add ESLint/Prettier/typecheck layers here — this is a PHP/Blade app.
