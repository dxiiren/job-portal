...
Write-Host ""
Write-Host "Job Portal Bootstrap Setup" -ForegroundColor Cyan
...
; --- job-portal setup.ps1 overrides ---
...
Write-Host "  3. Start the dev server on http://127.0.0.1:8108 :" -ForegroundColor Gray
