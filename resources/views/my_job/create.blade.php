        ...
        <form action="{{ route('my-jobs.store') }}" method="POST">
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    @php
                        $experiences = array_combine(
                            array_map('ucfirst', \App\Enums\JobExperienceEnum::values()),
                            \App\Enums\JobExperienceEnum::values(),
                        );
                    @endphp
                ...
                <div>
                    ...
                    <x-radio-group name="category" :options="\App\Enums\JobCategoryEnum::values()" />
                </div>
